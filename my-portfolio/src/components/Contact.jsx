      ...
      <div className="contact-container">
        ...
        <div className="contact-cards-wrapper">
          ...
          <div className="contact-info-card">
            ...
            <span className="card-label card-label-email">EMAIL</span>
            <div className="card-content">
              <a href="mailto:sjjyam04@gmail.com" className="card-link">
                <p className="card-email">sjjyam04@gmail.com</p>
              </a>
            </div>
          </div>
          ...
          <div className="contact-info-card">
            ...
            <div className="card-content social-icons-wrapper">
              ...
              <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" className="social-icon-link" title="Instagram">
                <svg className="social-icon" viewBox="0 0 24 24" fill="currentColor">
